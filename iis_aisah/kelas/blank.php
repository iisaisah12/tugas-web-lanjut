...
<head>
    ...
    <title>Data Adminitrasi - Blank</title>
...
<body id="page-top">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card-body table-responsive p-0">
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody class="alldata">
                                        <?php
                                        $sql = "SELECT kelas.id, kelas.dosen_id, kelas.nama_kelas, dosen.nama_dosen FROM kelas INNER JOIN dosen ON dosen.id = kelas.dosen_id";
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            <form action="" id="form_dosen">
                                                ...
                                                <input type="text" id="nama" name="namakelas" class="form-control" placeholder="nama kelas">
                                                <label for="">Dosen</label>
                                                <select name="txtDosen" id="dosen" class="form-control custom-select">
                                                    ...
                                                    <?php foreach($data as $opt): ?>
                                                        <?php echo '<option value="'.$opt['id'].'">'.$opt['nama_dosen'].'</option>'; ?>
                                                    <?php endforeach ?>
                                                </select>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            <form action="" id="form_dosenEdit">
                                                ...
                                                <input type="text" id="nama" name="namakelasEdit" class="form-control" placeholder="nama dosen">
                                                <label for="">Dosen</label>
                                                <select name="txtDosenEdit" id="dosen" class="form-control custom-select">
                                                    <option value="">Select Dosen</option>
                                                    <?php
                                                    $sql = "SELECT * FROM dosen";
                                                    $data = mysqli_query($conn, $sql);
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success:function(data){
                    if(!data.success){
                        ...
                        if(data.errors.dosen){
                            alert(data.errors.dosen);
                            $('#dosen').focus();
                            return false;
                        }
                    }else{
        ...
        function ganti(id){
            ...
            $.ajax({
                url : '../kelas/edit_kelas.php',
                type: 'POST',
                dataType: 'JSON',
                data : { id : id },
                success:function(data){
                    $('input[name="namakelasEdit"]').val(data.nama_kelas);
                    $('select[name="txtDosenEdit"]').val(data.dosen_id);
